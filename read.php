...
<div class ="page-content">
    <h1> Blood Information Read Page  </h1>
<ul>
...
<form action="" method="POST">
          Donor ID: <input type="number" name="donor_id"><br>
          <input type="submit">
      </form>
     ...
     if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql = "SELECT donor_id, blood_type, plasma_donation, date_of_donation FROM blood_info WHERE donor_id=${donor_id}";
