...
<div class ="page-content">
    <h1> Blood Information Update Page  </h1>
<ul>
...
<form action="" method="POST">
          ...
          Plasma Donation: <input type="text" name="plasma_donation"><br>
    ...
    <?php
      if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql = "UPDATE blood_info blood_type={$blood_type}, plasma_donation='{$plasma_donation}', 
        date_of_donation='{$date_of_donation}'WHERE donor_id={$donor_id}";
            if ($conn->query($sql) === TRUE) {
                echo "Blood Information updated successfully";
              } else {
